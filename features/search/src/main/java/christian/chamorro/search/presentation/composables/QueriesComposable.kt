            ...
            items(queries) { query ->
                ...
                Row(
                    Modifier
                        ...
                        .clickable {
                            setQuery(query)
                            onEvent(SearchPageEvent.GetProductsByQuery(query))
                        },
                    verticalAlignment = Alignment.CenterVertically
                ) {
                    Icon(
                        painter = painterResource(id = christian.chamorro.uicomponents.R.drawable.time_icon),
                        contentDescription = stringResource(id = R.string.previous_query)
                    )
                    ...
                    Icon(
                        painter = painterResource(
                            id = christian.chamorro.uicomponents.R.drawable.right_arrow_icon
                        ),
